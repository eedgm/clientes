        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('attaches.index') }}">
                        Attaches
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Attachment::class)
                        <x-dropdown-link href="{{ route('attachments.index') }}">
                        Attachments
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Developer::class)
                        <x-dropdown-link href="{{ route('developers.index') }}">
                        Developers
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Icon::class)
                        <x-dropdown-link href="{{ route('icons.index') }}">
                        Icons
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Payable::class)
                        <x-dropdown-link href="{{ route('payables.index') }}">
                        Payables
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Person::class)
                        <x-dropdown-link href="{{ route('people.index') }}">
                        People
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Priority::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\Rol::class)
                        <x-dropdown-link href="{{ route('rols.index') }}">
                        Rols
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Attach::class)
                <x-jet-responsive-nav-link href="{{ route('attaches.index') }}">
                Attaches
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Attachment::class)
                <x-jet-responsive-nav-link href="{{ route('attachments.index') }}">
                Attachments
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Client::class)
                ...
                @endcan
                @can('view-any', App\Models\Developer::class)
                <x-jet-responsive-nav-link href="{{ route('developers.index') }}">
                Developers
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Icon::class)
                <x-jet-responsive-nav-link href="{{ route('icons.index') }}">
                Icons
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Payable::class)
                <x-jet-responsive-nav-link href="{{ route('payables.index') }}">
                Payables
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Person::class)
                <x-jet-responsive-nav-link href="{{ route('people.index') }}">
                People
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Priority::class)
                <x-jet-responsive-nav-link href="{{ route('priorities.index') }}">
                Priorities
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Product::class)
                ...
                @endcan
                @can('view-any', App\Models\Proposal::class)
                <x-jet-responsive-nav-link href="{{ route('proposals.index') }}">
                Proposals
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Receipt::class)
                ...
                @endcan
                @can('view-any', App\Models\Rol::class)
                <x-jet-responsive-nav-link href="{{ route('rols.index') }}">
                Rols
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Skill::class)
                <x-jet-responsive-nav-link href="{{ route('skills.index') }}">
                Skills
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Statu::class)
                ...
                @endcan
                @can('view-any', App\Models\Task::class)
                <x-jet-responsive-nav-link href="{{ route('tasks.index') }}">
                Tasks
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Ticket::class)
