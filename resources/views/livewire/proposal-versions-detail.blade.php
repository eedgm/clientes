        ...
        <table class="w-full max-w-full mb-4 bg-transparent">
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.proposal_versions.inputs.time')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.cost_per_hour')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.hour_per_day')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.months_to_pay')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.unexpected')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.company_gain')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.bank_tax')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.proposal_versions.inputs.first_payment')
                    </th>
                    <th></th>
                </tr>
            </thead>
