...
class SkillControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_skills()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_skill()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_skill()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_skill()
    {
        $skill = Skill::factory()->create();
